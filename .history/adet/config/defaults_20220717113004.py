...
_C.MODEL.BOXINST.EMA_ON = False
_C.MODEL.BOXINST.COPYPASTE = False
...
_C.MODEL.BOXINST.PSEUDO_THRESH = 0.5
_C.MODEL.BOXINST.NUM_PROTO = 10
_C.MODEL.BOXINST.LENGTH = 50
