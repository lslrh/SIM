...
class COCOInstancePairOverlapDatasetMapper:
    ...
    def weak_transform(self, dataset_dict, image, augs):
        """weak augmentation"""
    ...
    def strong_transform(self, dataset_dict, image, augs):
        ...
        # ]
        augs.extend([*random.sample(self.strong_gens, 2)])
    ...
    def __call__(self, dataset_dict):
        ...
        pdb.set_trace()
        result_weak = self.weak_transform(copy.deepcopy(dataset_dict), image, augs)
        result_strong = self.strong_transform(copy.deepcopy(dataset_dict), image, augs)
