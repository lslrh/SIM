...
class COCOInstancePairOverlapDatasetMapper:
    ...
    def weak_transform(self, dataset_dict, image, overlap_bbox):
        """weak augmentation"""
    ...
    def strong_transform(self, dataset_dict, image, overlap_bbox):
    ...
    def __call__(self, dataset_dict):
        ...
        result_weak = self.weak_transform(copy.deepcopy(dataset_dict), image, (ox1, oy1, ox2, oy2))
        result_strong = self.strong_transform(copy.deepcopy(dataset_dict), image, (ox1, oy1, ox2, oy2))
