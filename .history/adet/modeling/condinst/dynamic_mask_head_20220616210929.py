        ...
        if self.training:
            ...
            if len(pred_instances) == 0:
                ...
                if self.boxinst_enabled:
                    ...
                    mask_feats_norm = l2_normalize(mask_feats)
                    mask_feat_similarity = get_feat_similarity(mask_feats_norm, self.pairwise_size, self.pairwise_dilation)
                    ...
                    pdb.set_trace()
                    # compute pseudo loss
                    pred_labels = torch.unique(pred_instances.labels, sorted=False)
                    pred_mask_list = []
