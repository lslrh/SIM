...
class CondInst(nn.Module):
    ...
    def forward(self, batched_inputs):   
        if self.MODEL.BOXINST.COPYPASTE and len(self.paste_data)==100:
            batched_inputs = _copypaste_transform(batched_inputs, self.paste_data)           
