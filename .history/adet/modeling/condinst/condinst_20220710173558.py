...
class CondInst(nn.Module):
    ...
    def forward(self, batched_inputs):
        ...
        if self.training:
            ...
            if self.ema_on:
                ...
                pdb.set_trace()
                mask_losses = self._forward_mask_heads_train(s_proposals, w_proposals, s_mask_feats, w_mask_feats, s_gt_instances, w_gt_instances)
    ...
    def _forward_mask_heads_train(self, s_proposals, w_proposals, s_mask_feats, w_mask_feats, s_gt_instances, w_gt_instances):
        ...
        loss_mask = self.mask_head(
            ...
            s_pred_instances, w_pred_instances, gt_instances
        )
