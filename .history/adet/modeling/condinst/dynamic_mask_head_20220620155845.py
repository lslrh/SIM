...
class DynamicMaskHead(nn.Module):
    ...
    def prototype_learning(self, _c, out_seg):
        return
        ...
        if self.training:
            ...
            if len(pred_instances) == 0:
                ...
                if self.boxinst_enabled:
                    ...
                    gt_classes = torch.cat([x.gt_classes for x in proto_masks_list])
                    self.prototype_learning(mask_feats, proto_masks, pred_instances.labels)
