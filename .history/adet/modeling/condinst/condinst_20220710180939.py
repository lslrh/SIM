    ...
    def forward(self, batched_inputs):
        ...
        if self.training:
            ...
            if self.ema_on:
                ...
                mask_losses = self._forward_mask_heads_train(s_proposals, w_proposals, s_mask_feats, s_mask_feats_ema, w_mask_feats, s_gt_instances)
            ...
            for im_id in range(num_images):
                ...
                for gt_ind in unique_gt_inds:
                    ...
                    if len(s_instances_per_gt) > num_instances_per_gt:
                        ...
                        inds = (scores * ctrness_pred).topk(k=num_instances_per_gt, dim=0)[1]
                        w_instances_per_gt_ema = w_instances_per_gt_ema[inds]
