            ...
            if len(pred_instances) == 0:
                ...
                if self.boxinst_enabled:
                    ...
                    if self._iter > 20000:
                        ...
                        warmup_factor_2 = min(self._iter.item() / float(60000), 1)
                        weights = ((pseudo_seg > thr) | (pseudo_seg < 0.4)) * gt_bitmasks
                        loss_pseudo = (mask_focal_loss(mask_scores, pseudo_seg_final.detach(), weights)) * warmup_factor_2 * 0.1
                        losses["loss_pseudo"] = loss_pseudo

                    # consistence loss
                    loss_consistence = self.loss_consistence()
