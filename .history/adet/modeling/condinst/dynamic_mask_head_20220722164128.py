        ...
        if self.training:
            ...
            if len(pred_instances) == 0:
                ...
                if self.boxinst_enabled:
                    ...
                    masks = (mask_scores_mean > 0.8) * gt_bitmasks.float()
                    if self._iter > 10000:
                        ...
                        paste_mask = mask_scores_mean > 0.6
                        start = 0
                        ...
                        if 'gt_masks' in gt_instances[0]._fields.keys():
                            ...
                            # pdb.set_trace()
                            loss_paste = (mask_focal_loss(mask_scores, gt_masks, weights)) * warmup_factor_2 * 1
