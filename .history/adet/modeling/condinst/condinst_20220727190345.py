...
class CondInst(nn.Module):
    ...
    def forward(self, batched_inputs):           
        ...
        if "instances" in batched_inputs[0]:
            ...
            if self.training and self.copypaste and len(self.paste_data)>=self.memory_length and >=0.5:
        ...
        if "instances" in batched_inputs[0]:
            if self.boxinst_enabled:
                if self.training and self.copypaste and len(self.paste_data)>=self.memory_length and random.random()>=0.5:
