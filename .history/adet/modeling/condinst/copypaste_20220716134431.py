...
def _copypaste_transform(self, original_data, paste_data):

    # get data
    original_data = copy.deepcopy(results)
    ...
    paste_data = copy.deepcopy(results['mix_results'][0])
...
def extract_bboxes(self, out_masks):
    bboxes = []
    keep_index = []
