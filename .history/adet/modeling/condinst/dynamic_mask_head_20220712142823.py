...
class DynamicMaskHead(nn.Module):
    ...
    def __call__(self, s_mask_feats, s_mask_feats_ema, w_mask_feats, mask_feat_stride, s_pred_instances, s_pred_instances_ema, w_pred_instances, gt_instances=None):
        if self.training:
            self._iter += 1
            ...
            if len(s_pred_instances) == 0:
                ...
                s_mask_logits_ema = self.mask_heads_forward_with_coords(
                    s_mask_feats_ema, mask_feat_stride, s_pred_instances_ema)
                s_mask_scores_ema = s_mask_logits_ema.sigmoid()
                ...
                if self.boxinst_enabled:
                    ...
                    s_mask_feats_ema = F.interpolate(
                                                s_mask_feats_ema,
                                                scale_factor=2,
