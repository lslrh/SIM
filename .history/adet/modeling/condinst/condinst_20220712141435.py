...
class CondInst(nn.Module):
    ...
    def _forward_mask_heads_train(self, s_proposals, s_proposals_ema, w_proposals, s_mask_feats, s_mask_feats_ema, w_mask_feats, s_gt_instances):
        ...
        loss_mask = self.mask_head(
            ...
            s_pred_instances, s_pred_instances_ema, w_pred_instances, s_gt_instances
        )
