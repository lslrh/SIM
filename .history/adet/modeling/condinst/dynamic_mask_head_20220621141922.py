...
class DynamicMaskHead(nn.Module):
    ...
    def prototype_learning(self, mask_feat, masks, mask_scores, gt_classes, im_inds):
        ...
        if self.training:
            ...
            if len(pred_instances) == 0:
                ...
                if self.boxinst_enabled:
                    ...
                    self.prototype_learning(mask_feats_norm, proto_masks, mask_scores, gt_classes, pred_instances.im_inds)
